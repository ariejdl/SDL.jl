...
stuff_lib = dlopen("sdl/initSDL.so") 

@get_c_fun stuff_lib auto initSDL(Int32,Int32,String,String)::Int32
initSDL() = initSDL(640,640,"Blank","Blank")

@get_c_fun stuff_lib auto SwapAndClear()::Int32

draw_funs_lib = dlopen("sdl/sdl_event.so")
